...
{
	SerialUSB.println("GSM3MobileMockupProvider::begin()");
	return 0;
};

int GSM3MobileMockupProvider::ready()
{
	SerialUSB.println("GSM3MobileMockupProvider::ready()");
	return 1;
};

int GSM3MobileMockupProvider::beginSMS(const char* number)
{
	SerialUSB.println("SM3MobileMockupProvider::beginSMS()");
	return 0;
};
...
{
	SerialUSB.println("GSM3MobileMockupProvider::endSMS()");
};

int GSM3MobileMockupProvider::availableSMS()
{
	SerialUSB.println("GSM3MobileMockupProvider::availableSMS()");
	return 120;
};
...
{
	SerialUSB.println("GSM3MobileMockupProvider::flushSMS()");
};
...
{
	SerialUSB.println("GSM3MobileMockupProvider::connectTCPClient()");
	SerialUSB.print(server);SerialUSB.print(":");SerialUSB.print(port);SerialUSB.print("-");SerialUSB.println(id_socket);
}
...
{
	SerialUSB.println("GSM3MobileMockupProvider::disconnectTCP()");
	return 1;
};

int GSM3MobileMockupProvider::connectTCPServer(int port, char* localIP, int* localIPlength)
{
	SerialUSB.println("GSM3MobileMockupProvider::connectTCPServer()");
